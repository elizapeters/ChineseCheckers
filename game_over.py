...
#check if either the top or the bottom triangles have won the game
...
#check if one the players of the middle triangles has won
...
#check if one of the players in middle triangles has won
